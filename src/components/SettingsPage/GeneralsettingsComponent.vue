  ...
  <div class="animate-in">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2">
      <div class="mr-2">
        ...
        <select id="language" class="block px-4 py-4 pt-4 w-full text-sm text-[#dfa027] bg-transparent rounded-xl border-1 border-gray-500 appearance-none focus:outline-none focus:ring-0 focus:border-[#dfa027] peer">
      ...
      <div>
        ...
        <select id="country" class="block px-4 py-4 pt-4 w-full text-sm text-[#dfa027] bg-transparent rounded-xl border-1 border-gray-500 appearance-none focus:outline-none focus:ring-0 focus:border-[#dfa027] peer">
    ...
    <button class="btn bg-[#dfa027] hover:bg-[#dfa027] hover:bg-opacity-80 text-white border-none py-3 px-6 rounded-lg mt-4 mb-12">Save Changes</button>
